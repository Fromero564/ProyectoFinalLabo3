...
//Seccion de electronica
 ...
 async function fetchDataElectronic() {
      const response = await fetch('https://fakestoreapi.com/products/category/electronics');
     dataInfoElectronic = await response.json();
     }

     function createCardsAllProductsElectronic() {
        const containerElectronics = document.getElementById('electronics-products'); // Selecciona el contenedor donde irán las tarjetas
        ...
        dataInfoElectronic.forEach(product => {
         ...
         cantidad.value = 1;
          ...
          cantidadContainer.appendChild(cantidad);
            ...
            card.appendChild(footer);
            // Añade la tarjeta completa al contenedor principal
            containerElectronics.appendChild(card);
